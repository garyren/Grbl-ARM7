...
#define defaults_h
...
#ifdef DEFAULTS_GARYS_CNC
  // Grbl settings for Gary's home made CNC.
  #define MICROSTEPS 4
  #define MOTOR_STEPS_PER_REV 200*MICROSTEPS
  #define XY_REV_PER_INCH 16
  #define  Z_REV_PER_INCH 24
  #define MM_PER_INCH 25.400

  #define DEFAULT_X_STEPS_PER_MM (MOTOR_STEPS_PER_REV * XY_REV_PER_INCH / MM_PER_INCH)        // 16 TPI, 200 steps per rotation
  #define DEFAULT_Y_STEPS_PER_MM (MOTOR_STEPS_PER_REV * XY_REV_PER_INCH / MM_PER_INCH)		//
  #define DEFAULT_Z_STEPS_PER_MM (MOTOR_STEPS_PER_REV *  Z_REV_PER_INCH / MM_PER_INCH)		// 24 TPI, 200 steps per rotation
  ...
  #define DEFAULT_STEPPING_INVERT_MASK (bfZDIR)				// invert Z
