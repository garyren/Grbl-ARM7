...
SRC = $(TARGET).c
SRC += armVIC.c coolant_control.c eeprom.c gcode.c limits.c motion_control.c nuts_bolts.c planner.c print.c protocol.c report.c serial.c  settings.c spindle_control.c stepper.c syscalls.c
