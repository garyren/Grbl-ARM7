...
//#define TICKS_PER_MICROSECOND (PCLK/1000000)
...
#define CMD_STATUS_REPORT '?'		// send status
#define CMD_FEED_HOLD '!'			// pause
...
#define DEFAULTS_GARYS_CNC		// type of machine parameters to use (== my own CNC).
...
#define	bfMS1   (1<<12)
#define	bfMS2   (1<<13)
#define	bfSPINDLE (1<<15)
#define bfI2C_SCL (1<<22)
#define bfI2C_SDA (1<<23)

#define bmDIRMASK (bfXDIR|bfYDIR|bfZDIR)
#define bmSTEPMASK (bfXSTEP|bfYSTEP|bfZSTEP)

// NOTE: All limit bit pins must be on the same port
#define LIMIT_DDR       IODIR
#define LIMIT_PIN       IOPIN
#define X_LIMIT_BIT     16  
#define Y_LIMIT_BIT     17 
#define Z_LIMIT_BIT     18  
#define X_ORIGIN_BIT	19
#define Y_ORIGIN_BIT	20
#define Z_ORIGIN_BIT	21
